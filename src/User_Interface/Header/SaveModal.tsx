...
export function SaveModal({ isOpen, onClose, isDarkMode }: SaveModalProps) {
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div>
              <p className={`mb-2 text-lg font-medium ${
                ...
                Store your chat permanently
              </p>
              <p className={`text-sm ${
                isDarkMode ? 'text-gray-400' : 'text-gray-700'
              }`}>
                Upgrade to our premium plan to securely save your chat history in-app
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className={`text-sm ${
                  ...
                  Includes unlimited chat history and premium features
                </p>
              </div>
            </div>
          </div>
